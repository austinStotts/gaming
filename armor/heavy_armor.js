...
import Leaping from '../bonuses/leaping';
import Ironheart from '../bonuses/ironheart';
...
let roll_bonus = (n) => {
    ...
    for(let i = 0; i < 20; i++) { list.push(new Swiftness()) }
    for(let i = 0; i < 20; i++) { list.push(new Turmoil()) }
    for(let i = 0; i < 20; i++) { list.push(new Leaping()) }
    for(let i = 0; i < 20; i++) { list.push(new Ironheart()) }
    let bonuses = [];
    for(let i = 0; i < n; i++) {
