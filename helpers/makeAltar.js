...
export default () => {
  ...
  let orbMat = new THREE.MeshBasicMaterial({ color:0x85e4ff })
  ...
  phyBody.userData = { collisionClass: "altar", construct_id: undefined, physicsMesh: alterMesh, name: "sacrifice" }
